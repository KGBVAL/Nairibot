Voici ton fichier entièrement corrigé. J'ai mis à jour les clés dans l'objet `channels` (`recrutement-interne` et `services` au lieu de `recrutement` et `service`) et j'ai corrigé les constantes correspondantes dans la fonction d'initialisation (`CONFIG_POSTOP.channels.recrutement-interne` n'étant pas valide en notation pointée, j'utilise la notation entre crochets `CONFIG_POSTOP.channels['recrutement-interne']`).
